/*********************************************************************
 Bobble for Bluefruit nRF52840 v2
 ...
 '+' Sets MOTORENABLE (pin 11) HIGH 
 '-' Sets MOTORENABLE (pin 11) LOW
 'F' Sets MOTOROUT1 (pin 13) HIGH and MOTOROUT2 (pin 12) LOW
 'R' Sets MOTOROUT1 (pin 13) LOW and MOTOROUT2 (pin 12) HIGH
 ...
 Pins 11, 13, 12 are designed to be connected to a L293DNE motor driver chip
 to drive a toy motor. Pin 11 will be connected to the EN chip enable pin. Pin 13
 and Pin 12 will be connected to the A chip pins. The motor will be connected to
 the Y chip pins.

 Pin A1/P0.03 is a connection point for a 50 element neopixel strand 

 Pin 10 is a connection point for a servo

 MOTORENABLE (pin 11) can also be used to control an external AC/DC Relay Outlet like
...
// setup neopixels
#define PIN A1 //A1 Neopixel strand
...
void setup()
{
  ...
  Bluefruit.setName("RTBobble52_0001");
  ...
  Serial.println("NEOPIXEL PIN=A1");
